extends Resource
class_name ModDraftConfig


@export var rarity_chances: Dictionary[ModDraft.Rarity, float]
@export var cooldown_mod_percentages: Dictionary[ModDraft.Rarity, float]
